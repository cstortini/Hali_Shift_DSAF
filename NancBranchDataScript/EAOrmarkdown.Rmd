...
abdest<- read.csv(here::here("2025-04-23/Output/IndexAbundance/AbundanceEstimates_GridCentriods_Reg.csv"))
  ...
  for (threshold in thresholds) {
    threshold_result <- data %>%
      ...
      mutate(Total_Abundance = sum(Abundance)) %>%
       mutate(Total_Area = sum(Area_km2)) %>% #correcting total_area calculation 
      ...
      summarize(
        ...
        Percent_Area_Used = Area_Threshold / Total_Area * 100,#correcting total_area calculation 
        #Total_Area = sum(Area_km2, na.rm = TRUE),
        Total_Area = first(Total_Area),##correcting total_area calculation
