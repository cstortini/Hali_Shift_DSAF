...
# ── Gradient background helpers for all plots ─────────────────────────────────
...
p1 <- ggplot(data_ordered,
  ...
  labs(
    title = NULL,
    x     = "Marge de sensibilité thermique (MST)",
    y     = ""
  ) +
  base_theme +
...
p2 <- ggplot(data_ordered,
  ...
  labs(
    title = NULL,
    x     = "Adaptabilité thermique (VTH)", #variabilité thermique de l'habitat
    y     = NULL
  ) +
  base_theme +
  theme(
...
legend_plot <- ggplot(data.frame(x = 0:1, y = 0), aes(x = x, y = y, fill = x)) +
  ...
  scale_fill_gradientn(
    colours = pale_cols,
    limits  = c(0, 1),
    name    = "Vulnérabilité Faible \u2192 Élevé",
...
final_plot <- ggdraw(plot_body) +
  draw_label(
    "Divisions de l'OPANO (du sud au nord)", #Divisions de l'Organisation des pêches de l'Atlantique Nord (du sud au nord)
...
# ── Save ──────────────────────────────────────────────────────────────────────
ggsave(
  filename = "CRIB results/AtlHalibut_CRIB_Full_and_3Indices_ByNAFO_FR.png",
  plot     = final_plot,
  width    = 18,
  height   = 10,
  dpi      = 400,
...
# Save as RDS
saveRDS(final_plot, "CRIB results/AH_CRIB_Full_and_3Indices_ByNAFO_FR.rds")
...
# ── Save ──────────────────────────────────────────────────────────────────────
ggsave(
  filename = "CRIB results/AtlCod_CRIB_Full_and_3Indices_ByNAFO_FR.png",
  plot     = final_plot,
  width    = 18,
  height   = 10,
  dpi      = 400,
...
# Save as RDS
saveRDS(final_plot, "CRIB results/AtlCod_CRIB_Full_and_3Indices_ByNAFO_FR.rds")
...
south_to_north <- c("4X","4VW","3NOPs","4RST","3KL","2JHG")
halcrib_with_zones_clean1$ND <- factor(halcrib_with_zones_clean1$NAFO_Zones, levels = south_to_north)
...
# ── Save ──────────────────────────────────────────────────────────────────────
ggsave(
  filename = "CRIB results/AmLob_CRIB_Full_and_3Indices_ByNAFO_FR.png",
  plot     = final_plot,
  width    = 18,
  height   = 10,
  dpi      = 400,
...
# Save as RDS
saveRDS(final_plot, "CRIB results/AmLob_CRIB_Full_and_3Indices_ByNAFO_FR.rds")
...
# ── Save ──────────────────────────────────────────────────────────────────────
ggsave(
  filename = "CRIB results/GH_CRIB_Full_and_3Indices_ByNAFO_FR.png",
  plot     = final_plot,
  width    = 18,
  height   = 10,
  dpi      = 400,
...
# Save as RDS
saveRDS(final_plot, "CRIB results/GH_CRIB_Full_and_3Indices_ByNAFO_FR.rds")
