...
VMAP <- ggplot() +
  ...
  theme_bw() +
  theme(axis.text = element_text(angle = 0, vjust = 0.2, hjust = 1, size = 8, family = "serif")) +
  labs(title = "a) Émissions élevées (SSP5-8.5)", x = "Longitude", y = "Latitude", color = "Vulnerability SSP5-8.5")
print(VMAP) 
...
VMAP2 <- ggplot() +
  ...
  theme_bw() +
  theme(axis.text = element_text(angle = 0, vjust = 0.2, hjust = 1, size = 8, family = "serif")) +
  labs(title = "b) Faibles émissions (SSP1-2.6)", x = "Longitude", y = "Latitude", color = "Vulnerability SSP5-8.5")
print(VMAP2)
...
ggsave(
  filename = "CRIB results/NAFO_AH_5Zto0A_2scenarios_FR.png",
  plot     = final_grob,
  width    = 10,
  height   = 5,
  dpi      = 400,
...
saveRDS(list(ssp85 = terra::wrap(raster_data1), 
        ...
        "CRIB results/AH_5Zto0A_2scenarios2_FR.rds")
...
ggsave(
  filename = "CRIB results/NAFO_GH_5Zto0A_2scenarios_FR.png",
  plot     = final_grob,
  width    = 10,
  height   = 5,
  dpi      = 400,
...
saveRDS(list(ssp85 = terra::wrap(raster_data1), 
             ssp26 = terra::wrap(raster_data2)),
        "CRIB results/GH_5Zto0A_2scenarios2_FR.rds")
...
ggsave(
  filename = "CRIB results/NAFO_AmLob_5Zto0A_2scenarios_FR.png",
  plot     = final_grob,
  width    = 10,
  height   = 5,
  dpi      = 400,
...
saveRDS(list(ssp85 = terra::wrap(raster_data1), 
             ssp26 = terra::wrap(raster_data2)),
        "CRIB results/AmLob_5Zto0A_2scenarios2_FR.rds")
...
ggsave(
  filename = "CRIB results/NAFO_AtlCod_5Zto0A_2scenarios_FR.png",
  plot     = final_grob,
  width    = 10,
  height   = 5,
  dpi      = 400,
...
saveRDS(list(ssp85 = terra::wrap(raster_data1), 
             ssp26 = terra::wrap(raster_data2)),
        "CRIB results/AtlCod_5Zto0A_2scenarios2_FR.rds")